...
-- ----------------------------------------------------------------------------
-- Verificaciones de integridad para soportar el formulario:
-- 1. category_id debe ser FK a venue_categories.
-- 2. location debe ser tipo GEOGRAPHY(POINT, 4326).

-- Nota: Si la columna location está como USER-DEFINED en el esquema, 
-- aseguramos que sea PostGIS Geometry/Geography.
-- (Este bloque es preventivo, si ya está bien, no hará nada dañino).

-- CREATE EXTENSION IF NOT EXISTS postgis SCHEMA extensions;
-- ALTER TABLE public.venues ALTER COLUMN location TYPE GEOGRAPHY(POINT, 4326) USING location::geography;
